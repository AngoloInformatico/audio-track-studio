...
La specifica completa è disponibile in `README_GUIDA.md` nella radice. Questo documento descrive l'avvio delle funzionalità implementate nelle Fasi 1–8 e nella Release 1.0.0.
